...
$get_billing = mysqli_query($connect,"SELECT * FROM `contactus` ") or die(mysqli_error());
$user=0;

while($get_billing_value = mysqli_fetch_array($get_billing)) 
{
    $user++;
$id      =  $get_billing_value['id'];
$name    =  $get_billing_value['name'];
$email   =  $get_billing_value['email'];
$company   =  $get_billing_value['company'];
$telephone =  $get_billing_value['telephone'];
$address1 =  $get_billing_value['address1'];
$address2 =  $get_billing_value['address2'];
$comment =  $get_billing_value['comment'];
}
?>
                        <tr>
                          <td>
