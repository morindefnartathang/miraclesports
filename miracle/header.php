				...
				<div class="container">	
					...
					<a class="navbar-brand order-1 order-lg-0 ml-lg-0 ml-2 me-auto" href="index.php">
						<div class="res-main-logo">
							<img src="images\miraclesports.jpg" alt="">
						</div>
						<div class="main-logo" id="logo">
							<img src="images\miraclesports.jpg" width=120px alt="">
						...
						<div class="offcanvas-body">
							...
							<ul class="navbar-nav justify-content-end flex-grow-1 pe_5">
                                ...
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
									<a class="nav-link active" aria-current="page" href="explore_events.php">Event</a>
								</li>
                                   <li class="nav-item">
									<a class="nav-link active" aria-current="page" href="contact_us.php">Contacts</a>
								</li>
								<!-- <li class="nav-item dropdown">
									<li><a class="dropdown-item" href="explore_events.html">Events</a></li>
								...
								<!-- <li class="nav-item dropdown">
									...
									<ul class="dropdown-menu dropdown-submenu">
										...
										<li>
											...
											<ul class="submenu dropdown-menu">
												<li><a class="dropdown-item pe-5" href="online_event_detail_view.php">Online Event Detail View</a></li>
												<li><a class="dropdown-item pe-5" href="venue_event_detail_view.php">Venue Event Detail View</a></li>
											</ul>
										</li>
