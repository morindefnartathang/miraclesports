...
<!-- Mirrored from www.gambolthemes.net/html-items/barren-html/disable-demo-link/online_event_detail_view.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Oct 2025 13:21:27 GMT -->
<head>
		<meta charset="utf-8">
					...
					<div class="col-xl-4 col-lg-5 col-md-12">
						<div class="main-card event-right-dt">
							...
							<div class="booking-btn">
								<a href="checkout.php" class="main-btn btn-hover w-100">Book Now</a>
							</div>
						</div>
					</div>
					<div class="col-xl-12 col-lg-12 col-md-12">
