...
<html lang="en">
	...
	<form method="post" onsubmit="return false;">
     ...
     <label>District:
        <input id="district" type="text" placeholder="Enter your district">
      </label>
      <br><br>
      
           <label>Get Score:
        <input id="getscore" type="text" placeholder="Enter your getscore">
      </label>
      <br><br>
      
           <label>Total Score:
        <input id="totalscore" type="text" placeholder="Enter your totalscore">
      </label>
      <br><br>
      
           <label>Stage:
        <input id="stage" type="text" placeholder="Enter your stage(1st Place)">
      </label>
      <br><br>
      
           <label>Category:
        <input id="category" type="text" placeholder="Enter your category">
      </label>
      <br><br>
...
//   const dateInput = document.getElementById('date');
  ...
  image.src = 'Certificate.png'; // Your background certificate template
  image.onload = () => {
    drawCertificate();
  };
  ...
  function drawCertificate() {
    ...
    ctx.fillText(nameInput.value, canvas.width / 1.7, 310);
    
    ctx.font = '25px Arial';
    ctx.fillStyle = '#022A3E';
    ctx.textAlign = 'center';
    ctx.fillText(district.value, canvas.width / 3.3, 355);
    
        ctx.font = '20px Arial';
    ctx.fillStyle = '#022A3E';
    ctx.textAlign = 'center';
    ctx.fillText(getscore.value, canvas.width / 1.9, 496);
    
       ctx.font = '20px Arial';
    ctx.fillStyle = '#022A3E';
    ctx.textAlign = 'center';
    ctx.fillText(totalscore.value, canvas.width / 1.3, 496);
    
        ctx.font = '20px Arial';
    ctx.fillStyle = '#022A3E';
    ctx.textAlign = 'center';
    ctx.fillText(stage.value, canvas.width /  2.3, 536);
    
        ctx.font = '20px Arial';
    ctx.fillStyle = '#022A3E';
    ctx.textAlign = 'center';
    ctx.fillText(category.value, canvas.width / 1.7, 536);
...
// ctx.fillText(formattedDate, (canvas.width / 2) + 210, 480);
  ...
  district.addEventListener('input', drawCertificate);
  getscore.addEventListener('input', drawCertificate);
  totalscore.addEventListener('input', drawCertificate);
  stage.addEventListener('input', drawCertificate);
  category.addEventListener('input', drawCertificate);
