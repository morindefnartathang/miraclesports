...
// echo "INSERT into home_slider1 (`slider_image`) values ('$uploaded_slider_image')";
// exit;

mysqli_query($connect,"INSERT into home_slider1 (`slider_image`) values ('$uploaded_slider_image')") or die(mysqli_error());
...
echo "<script type='text/javascript'>window.location = 'slider2.php?msg=added&action=list'</script>";
// echo "INSERT into home_slider1 (`slider_image`) values ('$uploaded_slider_image')";
// exit;
}
// Edit
...
mysqli_query($connect,"UPDATE home_slider1 SET `slider_image` = '$uploaded_slider_image' where slider_id = '$slider_id'") or die(mysqli_error());
echo "<div style='width: 350px; text-align: center; margin: 20% auto 0px; font-family: arial; font-size: 14px; border: 1px solid #ddd; padding: 20px 40px;'> 
Please wait while we update loading...</div>";
echo "<script type='text/javascript'>window.location = 'slider2.php?msg=updated&action=list'</script>";
}
// Delete
//deleting record
//action=delete&catid
...
$id  = $_GET['nwsevnt_id'];
$sql = "DELETE FROM home_slider1 WHERE slider_id = $id;";
...
echo "<script type='text/javascript'>window.location = 'slider2.php?msg=deleted&action=list'</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
                  ...
                  <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                      ...
                      <tbody>
                        <?php
$sno =0;
$get_organic = mysqli_query($connect,"SELECT * FROM `home_slider1` ") or die(mysqli_error());
...
?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-warning  btn-xs" href="slider2.php?action=edit&nwsevnt_id=<?php echo base64_encode($slider_id); ?>">
                              <i class="fa fa-pencil" aria-hidden="true">
                              </i> Edit
                            </a>
                            <a class="btn btn-xs red"  onClick="delete_menu('slider2.php?action=delete&nwsevnt_id=<?php echo $slider_id; ?>')" href="javascript:;">
                              <i class="icon-trash">
                              </i> Delete
                            </a>
                          </td>
...
$get_about_edit = mysqli_query($connect,"SELECT * FROM `home_slider1` where slider_id = '$NewsID'") or die(mysqli_error());
