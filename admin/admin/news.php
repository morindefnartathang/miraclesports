                                ...
                                <div class="col-md-12">
                                    <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                        ...
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-globe"></i>News</div>
                                                <div class="actions">
                                                <a href="newsAdd.php" class="btn btn-default btn-sm">
                                        ...
                                        <?php pageStatus($status); ?>
                                            <table class="table table-striped table-bordered table-hover" id="sample_2">
                                               ...
                                               // die();
                            $get_product = mysqli_query($connect,"SELECT * FROM news") or die(mysqli_error());
                                                ...
                                                while($get_value = mysqli_fetch_array($get_product)) 
                                                {
                                                    ...
                                                    $content = htmlspecialchars_decode(trim(strip_tags($get_value['content'])));
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-info btn-xs" data-toggle="modal" href="#Product<?php echo $id; ?>"><i class="fa fa-eye" aria-hidden="true"></i> View </a>

                                                            <a class="btn btn-warning  btn-xs" href="newsEdit.php?action=edit&nwsevnt_id=<?php echo base64_encode($id); ?>">
                                                            <i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>

                                                            <a class="btn btn-xs btn-danger"  onClick="delete_menu('news.php?action=delete&nwsevnt_id=<?php echo $id; ?>')" href="javascript:;">
                                                            <i class="fa fa-trash"></i> Delete</a>

                                                        </td>

                <!-- Pop Up -->
                <div class="modal fade" id="Product<?php echo $id; ?>" tabindex="-1" role="basic" aria-hidden="true">
