...
if ($_POST['block'] == 'd_reg') 
{
   ...
   echo "<script type='text/javascript'>window.location = 'reg_distributer.php'</script>";
}
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                      <thead>
                        <tr class="">
                          ...
                          <th> Distributer Mobile No
                          </th>
                          
                          <th> Distributer Mail ID
                          </th>
                        
                            <th> Referred Customer
                          </th>
...
$get_customer = mysqli_query($connect,"SELECT * FROM registered_users where user_level = '2'  ") or die(mysqli_error());
...
?>
                        <tr>
                          ...
                          <td>
                            <?php 
                            // echo "SELECT * FROM registered_users where ref_id = '$registered_users_id'  ";
                            
                            $get_cust_ref = mysqli_query($connect,"SELECT * FROM registered_users where ref_id = '$registered_users_id'  ") or die(mysqli_error());
                                while($get_value_ref = mysqli_fetch_array($get_cust_ref)) 
                                {
                                $sno++;    
                                $user_name_ref = $get_value_ref['user_name'];    
                                                 
                            echo $user_name_ref . "<br>";
...
echo $join_date;
                          ...
                          <td>
                            <a class="btn btn-info btn-xs" data-toggle="modal" href="#billing<?php echo $registered_users_id; ?>">
                             ...
                             <a class="btn btn-xs btn-danger"  onClick="delete_menu('reg_distributer.php?action=delete&nwsevnt_id=<?php echo $registered_users_id; ?>')" href="javascript:;">
