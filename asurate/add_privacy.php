<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("ythiay")){}?><?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("lztfqo")){}?><?php
session_start();
...
if ($_POST['add'] == 'Create') {
    ...
    mysqli_query($connect,"INSERT into privacy_content (`privacy_content`) values ('$privacy_content')") or die(mysqli_error());
...
if ($_POST['update_page'] == 'Update') {
    ...
    $privacy_id = $_POST['privacy_id'];
    $privacy_content   = $_POST['privacy_content'];

  mysqli_query($connect,"UPDATE privacy SET `privacy_content` = '$privacy_content' where privacy_id = '$privacy_id'") or die(mysqli_error());
    ...
    echo "<script type='text/javascript'>window.location = 'add_privacy.php?msg=updated&action=list'</script>";
}
...
if ($_GET['action'] == 'delete') {
    ...
    echo "<div style='width: 350px; text-align: center; margin: 20% auto 0px; font-family: arial; font-size: 14px; border: 1px solid #ddd; padding: 20px 40px;'>Please wait while we update the record loading...</div>";
        ...
        echo "<script type='text/javascript'>window.location = 'add_privacy.php?msg=deleted&action=list'</script>";
...
<head>
            ...
            <meta charset="utf-8" />
        <title>Add privacy  | <?php echo $site_title; ?></title>
                                ...
                                <div class="col-md-12">
                                    <!-- BEGIN EXAMPLE TABLE PORTLET-->
                                        ...
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-globe"></i>Privacy and Policy</div>
                                                <!-- <div class="actions">
...
<textarea class="form-control ckeditor" name="privacy_content"></textarea>
...
<!--===================================================== End Add Popup ========================================== -->
                                        ...
                                        <?php pageStatus($status); ?>
                                            <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                ...
                                                <?php
                                                $sno =0;
                                                $get_organic = mysqli_query($connect,"SELECT * FROM `privacy` ") or die(mysqli_error());
                                                while($get_value = mysqli_fetch_array($get_organic)) 
                                                {
                                                    $sno++;
                                                    $privacy_id = $get_value['privacy_id'];
                                                    $privacy_content = $get_value['privacy_content'];
                                                
                                                ?>
                                                    <tr>
                                                        <td><?php echo $sno;?> </td>
                                                        <td><a class="btn btn-info btn-xs" data-toggle="modal" href="#privacy<?php echo $privacy_id; ?>"><i class="fa fa-eye" aria-hidden="true"></i> View </a></td>
                                                        <td>

                                                            <a class="btn btn-warning  btn-xs" href="add_privacy.php?action=edit&nwsevnt_id=<?php echo base64_encode($privacy_id); ?>">
                                                            <i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>

<!--                                                             <a class="btn btn-xs red"  onClick="delete_menu('organic_menu.php?action=delete&nwsevnt_id=<?php echo $privacy_id; ?>')" href="javascript:;">
                                                            <i class="icon-trash"></i> Delete</a> -->

                                                        </td>

                                                        <!-- Pop Up -->
                                                        <div class="modal fade" id="privacy<?php echo $privacy_id; ?>" tabindex="-1" role="basic" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            ...
                            <!-- /.modal-dialog -->
                             ...
                             <?php
                               ...
                               // die();
                               $get_about_edit = mysqli_query($connect,"SELECT * FROM `privacy` where privacy_id = '$NewsID'") or die(mysqli_error());
                                                while($get_edit = mysqli_fetch_array($get_about_edit)) 
                                                {
                                                    $sno++;
                                                    $privacy_id = $get_edit['privacy_id'];
                                                    $privacy_content = $get_edit['privacy_content'];
                                }
                               ?>
                               <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <form action="" id="form_sample_1" method="post" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <input type="hidden" name="privacy_id" value="<?php echo $privacy_id; ?>">
