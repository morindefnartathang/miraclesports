...
// SELECT `id`, `content`, `date` FROM `news` WHERE 1

$news   = $_POST['news'];

$today=date('Y-m-d');

mysqli_query($connect,"INSERT INTO `news`(`content`, `date`) VALUES ('$news' ,'$today')") or die(mysqli_error());
...
<head>
<meta charset="utf-8" />
<title>Product Add | <?php echo $site_title; ?></title>
...
<label class="control-label col-md-3">News Content :
<span class="required" aria-required="true"> * </span>
</label>
<div class="col-md-6">
<textarea name="news" data-required="1" class="form-control ckeditor" rows="5" id="product_description"></textarea>
</div>
</div>
